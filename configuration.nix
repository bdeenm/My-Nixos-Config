...

{
  ...
  environment.gnome.excludePackages = (with pkgs; [
    ...
    users.users.b_demharter = {
      ...
      packages = with pkgs; [
      firefox thunderbird kicad bitwarden sublime4 tor-browser-bundle-bin teams wine 
      wesnoth libreoffice krita drawing discord texworks texlive.combined.scheme-full
      chromium brlaser
      ];
    };
    ...
    #atlas
    libtool pkg-config autoconf automake sshpass gcc libcxx
    #other
    vim wget git gcc appimage-run jdk zlib curl php cmake pdftk
    ];
